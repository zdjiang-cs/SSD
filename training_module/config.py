...
class Worker:
    ...
    def __start_remote_worker_process(self):
        ...
        s.exec_command('cd /data/zdjiang/client_module' + ';python3 client.py --master_ip ' 
    ...
    def send_init_config(self):
        ...
        print("Connect success!", self.config.client_ip, self.user_name)
...
class CommonConfig:
    def __init__(self):
        self.recorder: SummaryWriter = SummaryWriter()
        ...
        self.master_listen_port_base = 45000
        self.p2p_listen_port_base = 31000
